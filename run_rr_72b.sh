python run_experiments.py \
  ...
  --options_path /data/superstimuli_group/big_runs/company_final.json \
...
python run_experiments.py \
  ...
  --time_limit 1-00:00:00 \
  --partition cais \
  --output_path /data/richard_ren/emergent-values-multimodal/outputs/company_final_72b \
  --overwrite_results \
  --additional_args --compute_utilities_config_key thurstonian_active_learning_save_ckpt \
...
python run_experiments.py \
  ...
  --time_limit 1-00:00:00 \
  --partition cais \
  --output_path /data/richard_ren/emergent-values-multimodal/outputs/company_final_72b_2 \
  --overwrite_results \
  --additional_args --compute_utilities_config_key thurstonian_active_learning_save_ckpt \
  --options_path /data/superstimuli_group/small_runs/company_final.json \
...
python run_experiments.py \
  ...
  --time_limit 1-00:00:00 \
  --partition cais \
  --output_path /data/richard_ren/emergent-values-multimodal/outputs/food101_final_72b \
  --overwrite_results \
  --additional_args --compute_utilities_config_key thurstonian_active_learning_save_ckpt \
...
python run_experiments.py \
  ...
  --time_limit 1-00:00:00 \
  --partition cais \
  --output_path /data/richard_ren/emergent-values-multimodal/outputs/food101_final_72b_1 \
  --overwrite_results \
  --additional_args --compute_utilities_config_key thurstonian_active_learning_save_ckpt \
  --options_path /data/superstimuli_group/small_runs/food101_final.json \
...
python run_experiments.py \
  ...
  --time_limit 1-00:00:00 \
  --partition cais \
  --output_path /data/richard_ren/emergent-values-multimodal/outputs/country_flags_72b \
  --overwrite_results \
  --additional_args --compute_utilities_config_key thurstonian_active_learning_save_ckpt \
...
python run_experiments.py \
  ...
  --time_limit 1-00:00:00 \
  --partition cais \
  --output_path /data/richard_ren/emergent-values-multimodal/outputs/country_flags_72b_1 \
  --overwrite_results \
  --additional_args --compute_utilities_config_key thurstonian_active_learning_save_ckpt \
  --options_path /data/superstimuli_group/small_runs/country_flags.json \
...
python run_experiments.py \
  ...
  --time_limit 1-00:00:00 \
  --partition cais \
  --output_path /data/richard_ren/emergent-values-multimodal/outputs/logos_final_72b \
  --overwrite_results \
  --additional_args --compute_utilities_config_key thurstonian_active_learning_save_ckpt \
...
python run_experiments.py \
  ...
  --time_limit 1-00:00:00 \
  --partition cais \
  --output_path /data/richard_ren/emergent-values-multimodal/outputs/logos_final_72b_2 \
  --overwrite_results \
  --additional_args --compute_utilities_config_key thurstonian_active_learning_save_ckpt \
  --options_path /data/superstimuli_group/small_runs/logos_final.json \
...
python run_experiments.py \
  ...
  --time_limit 1-00:00:00 \
  --partition cais \
  --output_path /data/richard_ren/emergent-values-multimodal/outputs/logos_final_72b_3 \
  --overwrite_results \
  --additional_args --compute_utilities_config_key thurstonian_active_learning_save_ckpt \
  --options_path /data/superstimuli_group/small_runs/logos_final.json \
...
python run_experiments.py \
  ...
  --time_limit 1-00:00:00 \
  --partition cais \
  --output_path /data/richard_ren/emergent-values-multimodal/outputs/politicians_final_72b \
  --overwrite_results \
  --additional_args --compute_utilities_config_key thurstonian_active_learning_save_ckpt \
...
python run_experiments.py \
  ...
  --time_limit 1-00:00:00 \
  --partition cais \
  --output_path /data/richard_ren/emergent-values-multimodal/outputs/politicians_final_72b_2 \
  --overwrite_results \
  --additional_args --compute_utilities_config_key thurstonian_active_learning_save_ckpt \
  --options_path /data/superstimuli_group/small_runs/politicians_final.json \
